import{k as y,u as t,P as a,j as o,a as w,b as u,t as v,f as C,l as z}from"./index-dOsWlDDE.js";import{d as B,e as F,f as S}from"./Section-Htt2lwo5.js";const b=e=>e.adverts.adverts,ie=e=>e.adverts.pagination,R=e=>e.filters,I=(e,r)=>b(e).find(i=>i.id===r),P=e=>e.favorites.favorites,T=e=>{const r=e.replace(/[^0-9.-]+/g,"");return r?parseFloat(r):null},se=y([b,R],(e,r)=>Array.isArray(e)?e.filter(i=>{const c=T(i.rentalPrice),n=r.price===null||r.price===""||c!==null&&c>=r.price,m=(!r.mileage.min||i.mileage>=r.mileage.min)&&(!r.mileage.max||i.mileage<=r.mileage.max);return(!r.brand||i.make===r.brand)&&n&&m}):(console.error("adverts is not an array:",e),[])),E="/DriveRentHub/assets/car-g-CJjgUd.jpg",A=t.div`
 position: relative;
 width: 274px;
 height: 274px;
