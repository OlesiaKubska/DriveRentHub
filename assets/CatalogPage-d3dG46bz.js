import{u as d,a as M,b as w,j as s,s as L,c as F,d as A,e as I,r as Q,f as v,g as U,i as q,h as H,p as N}from"./index-ToSPHxcf.js";import{g as $,s as R,C as D,A as W,B as G,M as V}from"./CarList.styled-vD3RiPvy.js";import{G as Y,S as K,H as J}from"./Section-ll12dPQj.js";const X=["Buick","Volvo","HUMMER","Subaru","Mitsubishi","Nissan","Lincoln","GMC","Hyundai","MINI","Bentley","Mercedes-Benz","Aston Martin","Pontiac","Lamborghini","Audi","BMW","Chevrolet","Chrysler","Kia","Land"],Z=d.div`
 display: flex;
 align-items: center;
